...
VALUES
(100, NULL, '系统管理', '/system', 'Layout', 'i-ant-design:setting-filled', 10, FALSE, NOW(), NOW()),
(1001, 100, '租户管理', '/system/tenant', 'views/system/tenant/index', 'i-ant-design:team-outlined', 11, FALSE, NOW(), NOW()),
(1002, 100, '用户管理', '/system/user', 'views/system/user/index', 'i-ant-design:user-outlined', 21, FALSE, NOW(), NOW()),
(1003, 100, '角色管理', '/system/role', 'views/system/role/index', 'i-ant-design:safety-outlined', 31, FALSE, NOW(), NOW()),
